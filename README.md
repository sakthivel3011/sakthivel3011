...
### Full Stack Web Developer · AI & Data Science Student · Founder @ Updone

*I build web apps, event systems, admin dashboards, automation tools, and full-stack SaaS products.*
...
-  Full-Stack Developer — from UI design to backend APIs and cloud deployment
-  Founder & Creator of [Updone](https://updone.in) — a suite of real-world web products
-  Building event technology platforms used in colleges and organizations
-  Developing automation tools for email campaigns, attendance, and form workflows
-  Delivering freelance & business websites for brands and service companies

---

##  Projects

| Project | Type | Live Link | Description |
|:---|:---|:---:|:---|
| UPDONE | Company Platform | [ Visit](https://updone.in) | Digital product and service platform showcasing Updone tools, portfolio, and web solutions. |
| EVENT  | Event Operating System | [ Visit](https://event.updone.in) | Complete event management — registrations, coordinators, entries, audio uploads, live points, dashboards, and admin control. |
| MARK  | Attendance Platform | [ Visit](https://mark.updone.in) | Smart attendance system with QR-based check-in, GPS validation, analytics, and admin dashboard. |
| INBOX  | Email Automation SaaS | [ Visit](https://inbox.updone.in) | Bulk email and campaign management with templates, campaign history, Google Sheets import, and dashboard. |
| ZHAGARAM | Event Brand Website | [ Visit](https://zhagaramm.com) | Premium event management website for weddings, cultural events, concerts, and corporate functions. |
| TCF | Event Website | [ Visit](https://tcf.updone.in) | Techno Cultural Fest site with event details, registration flow, and participant information. |
| CMC | Club Website | [ Visit](https://cmc.updone.in) | Cultural and Music Club portal for events, announcements, registrations, results, and student activities. |
| EEC / EECC | Club Website | [ Visit](https://eecc.kongu.edu) | Energy and Environment Conservation Club website for club activities and events. |
